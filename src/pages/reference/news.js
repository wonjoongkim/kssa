...
import { NewsRegister } from 'pages/reference/newsRegister';
import { NewsModify } from 'pages/reference/newsModify';
...
export const Reference_News = () => {
    ...
    return (
        <>
            ...
            >
                <NewsRegister ModalClose={handleCancel_Re} SaveClose={SaveClose} />
            </Modal>
            {/* 최신뉴스 등록 모달 창 End */}
            ...
            <Modal
                ...
                getContainer={() => document.body}
            >
                <NewsModify ModalClose={handleCancel_Mo} seqIdProps={seqIdValue} datetime={minutes + seconds} SaveClose={SaveClose} />
            </Modal>
            {/* 최신뉴스 수정 모달 창 End */}

            {/* 최신뉴스 상세정보 모달 창 Start */}
            <Modal
                maskClosable={false}
                open={ModalOpenVi}
                onOk={handleOk_Vi}
                ...
                getContainer={() => document.body}
            >
                <NewsView ModalClose={handleCancel_Vi} datetime={minutes + seconds} seqIdValue={seqIdValue} />
            </Modal>
            {/* 최신뉴스 상세정보 모달 창 End */}
        </>
    );
